...
key <- read_key_csv(here("data", "key.csv"))

trab <- read_trabecular_csv(here("data", "trabecular.csv"), key)

cort <- read_cortical_csv(here("data", "twice1.csv"), 
                          here("data", "twice2.csv"), 
                          key)

mfe <- read_mfe_csv(here("data", "mfe.csv"), key)
```
