...
This is a step-by-step to running a standard microCT analysis using microCTr.
It assumes you already have your data exported from the scanner into text files.
